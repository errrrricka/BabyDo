/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript&plugins=line-highlight+line-numbers+file-highlight+toolbar+previewer-base+previewer-time+copy-to-clipboard */
...
function highlightLines(pre, lines, classes) {
	...
	for (var i=0, range; range = ranges[i++];) {
		...
		if(true) {
			...
			if(end > start) {
				line.setAttribute('data-end', ' ');
			}
		}

		line.style.top = (start - offset - 1) * lineHeight + 'px';
		line.id = 'line-' + ((parseInt(line.style.top) / lineHeight) + 1);
...
(function() {
    ...
    self.Prism.lineNumbers = function() {
